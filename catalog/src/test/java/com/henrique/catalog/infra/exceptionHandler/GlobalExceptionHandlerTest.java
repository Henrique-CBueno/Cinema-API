...
class GlobalExceptionHandlerTest {
    ...
    class MovieDontExists {
        ...
        void shouldReturnNotFoundStatusWhenMovieNotFound() {
            ...
            // Act
            ResponseEntity<ErrorGlobalResponse> response = 
                    exceptionHandler.movieDontExists(exception);
        ...
        void shouldHandleMultipleDifferentNotFoundExceptions() {
            ...
            // Act & Assert
            ResponseEntity<ErrorGlobalResponse> response1 = 
                    exceptionHandler.movieDontExists(new NotFoundException(message1));
            ResponseEntity<ErrorGlobalResponse> response2 = 
                    exceptionHandler.movieDontExists(new NotFoundException(message2));
    ...
    class DuplicateResource {
        ...
        void shouldReturnConflictStatusWhenDuplicateResourceFound() {
            ...
            // Act
            ResponseEntity<ErrorGlobalResponse> response = 
                    exceptionHandler.duplicateResource(exception);
        ...
        void shouldHandleDuplicateResourceWithSimpleMessage() {
            ...
            DuplicateResourceException exception = 
                    new DuplicateResourceException("This resource already exists");
    ...
    class HandleValidationErrors {
        ...
        void shouldReturnUnprocessableContentStatusForValidationError() {
            ...
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException("O título é obrigatório");
        ...
        void shouldReturnValidationErrorMessage() {
            ...
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException(validationMessage);
        ...
        void shouldReturnUnprocessableContentStatusNameInResponse() {
            // Arrange
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException("A descrição é obrigatória");
        ...
        void shouldIncludeTimestampForValidationError() {
            // Arrange
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException("A duração é obrigatória");
            LocalDateTime beforeTest = LocalDateTime.now();
        ...
        void shouldReturnFirstFieldErrorWhenMultipleErrorsExist() {
            ...
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationExceptionWithMultipleErrors(
                            fieldNames, 
                            messages);
        ...
        void shouldHandleMultipleDifferentValidationMessages() {
            ...
            for (String message : validationMessages) {
                MethodArgumentNotValidException exception = 
                        MethodArgumentNotValidExceptionFactory.createValidationException(message);
        ...
        void shouldHandleValidationWithSpecificFieldName() {
            ...
            String validationMessage = "O título é obrigatório";
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException(fieldName, validationMessage);
        ...
        void shouldHandleValidationErrorsWithBodyStructure() {
            // Arrange
            MethodArgumentNotValidException exception = 
                    MethodArgumentNotValidExceptionFactory.createValidationException(
                            "durationMinutes",
                            "A duração deve ser de pelo menos 1 minuto");
